...
scenarios = {
    "standard": [
        {"role": "agent", "text": "Hello... um, this is Iddu, calling on behalf of Jordan Rivera regarding an appointment at Metro Health."},
        {"role": "clinic", "text": "Hi... let me pull that up. Can you, uh, confirm the patient’s date of birth and address?"},
        {"role": "agent", "text": "Certainly. Date of birth is... let me see... 05/xx/19xx and the address is 123 xxxxx Lane, APT 4B."},
        {"role": "clinic", "text": "Thank you... hmm, that matches. How can I help you today?"},
        {"role": "agent", "text": "Jordan needs to reschedule their follow-up for next Tuesday. Do you have anything, uh, available in the morning?"},
    ...
    "complex": [
        ...
        {"role": "agent", "text": "Hello... um, this is Jordan Rivera’s personal AI assistant. Jordan needs to move his follow-up. He is looking for next week Tuesday or Wednesday... specifically between 2:00 PM and 4:00 PM."},
        ...
        {"role": "agent", "text": "Jordan specifically requested no Fridays. Could you check again for any Tuesday or Wednesday slots between 2:00 and 4:00 PM? He’s... uh, flexible within that window."},
